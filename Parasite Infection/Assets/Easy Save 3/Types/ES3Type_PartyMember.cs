...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("upgradePoints", "modSlots", "characterName", "health", "maxHealth", "attackPower", "defensePower", "energyPoints", "maxEnergyPoints", "speed", "abilities", "abilitiesList", "level", "experience", "equipment", "originalMaxHealth", "originalMaxEP", "originalAttackPower", "originalDefensePower", "upgradePointsDictionary")]
	public class ES3Type_PartyMember : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("upgradePoints", instance.upgradePoints, ES3Type_int.Instance);
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "upgradePoints":
						instance.upgradePoints = reader.Read<System.Int32>(ES3Type_int.Instance);
						break;
					case "modSlots":
